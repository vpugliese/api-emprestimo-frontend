    ...
    cb = () => { }) {
        ...
        if (maskExpression.startsWith('percent')) {
            ...
            let i = 0, inputSymbol = inputArray[0]; i < inputArray.length; i++, inputSymbol = (_c = inputArray[i]) !== null && _c !== void 0 ? _c : '') {
                ...
                if (this._checkSymbolMask(inputSymbol, (_d = maskExpression[cursor]) !== null && _d !== void 0 ? _d : '') &&
                ...
                else if (this.specialCharacters.indexOf((_j = maskExpression[cursor]) !== null && _j !== void 0 ? _j : '') !== -1) {
                    ...
                    this.patterns[(_k = maskExpression[cursor]) !== null && _k !== void 0 ? _k : ''] &&
                    ((_m = this.patterns[(_l = maskExpression[cursor]) !== null && _l !== void 0 ? _l : '']) === null || _m === void 0 ? void 0 : _m.optional)) {
        ...
        if (result.length + 1 === maskExpression.length &&
            this.specialCharacters.indexOf((_q = maskExpression[maskExpression.length - 1]) !== null && _q !== void 0 ? _q : '') !== -1) {
...
class NgxMaskService extends NgxMaskApplierService {
    ...
    hideInput(inputValue, maskExpression) {
        return inputValue
            ...
            var _a, _b, _c, _d, _e;
            if (this.patterns &&
                this.patterns[(_a = maskExpression[index]) !== null && _a !== void 0 ? _a : ''] &&
                ((_c = this.patterns[(_b = maskExpression[index]) !== null && _b !== void 0 ? _b : '']) === null || _c === void 0 ? void 0 : _c.symbol)) {
                return (_e = this.patterns[(_d = maskExpression[index]) !== null && _d !== void 0 ? _d : '']) === null || _e === void 0 ? void 0 : _e.symbol;
            }
            return curr;
        })
            .join('');
